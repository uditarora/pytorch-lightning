...
- Fixed an issue with `auto_collect_arguments` collecting local variables that are not constructor arguments ([#2048](https://github.com/PyTorchLightning/pytorch-lightning/pull/2048))
